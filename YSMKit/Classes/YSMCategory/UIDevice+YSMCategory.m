//
//  UIDevice+YSMCategory.m
//  YSMKit
//
//  Created by duanzengguang on 2018/9/7.
//

#import "UIDevice+YSMCategory.h"
...
@implementation UIDevice (YSMCategory)
...
- (NSString *)deviceResolution {
    ...
    return [NSString stringWithFormat:@"%fx%f",screen_size.width*scale,screen_size.height*scale];
}
